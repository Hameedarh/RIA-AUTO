        ...
        <div  className='service-cont'>
            ...
            <div className='serdiv'>
                ...
                <div className='serdiv2'>
                    <p>We use <span style={{color:"rgb(61, 46, 145) "}}>High-Quality</span> paints, automated baking oven, car waxing/buffing to ensure high quality of service is delivered to our prestigious clients/customers </p>
                </div>
            </div>
